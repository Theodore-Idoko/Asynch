...
//Update Post
//http.put('https://jsonplaceholder.typicode.com/users/2', data).then(data => console.log(data)).catch(err => console.log(err)); //the number 2 after the user indicates the position or place you want it to be updated
